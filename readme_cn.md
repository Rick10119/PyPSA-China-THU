...
- 光伏：`solar capacity.csv` 的 `2025` 列由脚本 `scripts/recompute_solar_2025_from_nea_sep2025.py` 根据国家能源局《[2025年前三季度光伏发电建设情况](https://www.nea.gov.cn/20251112/35126d06a151461882b61d0a2e5706a6/c.html)》中 **各省“截至 2025 年 9 月底累计并网容量”合计（万千瓦）×10→MW** 作为 \(C^{total}\)，再按 \(\Delta=\max(C^{total}-C^{cum}_{\le2020},\,0)\) 写入。说明：该公报同时给出 **2025 年前三季度新增**，但**分省表未直接给出 2021–2025 五年累计新增**；上述做法与“官方累计装机”对齐，时间节点为 **2025-09 末**而非 2025 年末。若需 strictly 2021–2025 或 2025 全年末，可待对应分省累计表发布后改 \(C^{total}\) 并重跑脚本。
...
- **2025 年前三季度光伏发电建设情况（分省：前三季度新增、截至 9 月底累计，万千瓦）**：`https://www.nea.gov.cn/20251112/35126d06a151461882b61d0a2e5706a6/c.html`
